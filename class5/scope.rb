...
# right now, "chant" is outside of the local variable
# if you have $ then it is a global variable - you can referance it - this is bad practice cause it can 
...
mazda = Car.new #this creates a class of the object CAR - find the methods and makes them avaliable for calls later
mazda.fill_er_up
mazda.start_car!
