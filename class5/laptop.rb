...
# File name is offen the same as the class name

class Laptop
	attr_accessor :brand, :screen_size, :power

	def initialize(brand, screen_size) #method
		@brand = brand #instance valuables applies to the whole class
		@screen_size = screen_size
		@power = false
	end

	def power?(state) #Return state
		@power = state
	end
