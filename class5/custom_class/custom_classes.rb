...
#
#  Once you've defined the class, write code below the comments to create a Person object initialized with your own first and last name, then print your full name to the command line using the get_full_name method. 
